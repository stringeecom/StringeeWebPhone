...
$file3 = file_get_contents('css/util-select.css');
$file4 = file_get_contents('css/style.css');
...
?>
    ...
    <?
//build JS===================================================== ==>
$file1 = file_get_contents('js/socket.io-2.2.0.js');
$file2 = file_get_contents('js/StringeeSDK-1.5.10.js');
