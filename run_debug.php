    ...
    <script>
        ...
        function openPopupWindow(answerIncomingCallBtnClick) {
            if (callPopupWindow === null || callPopupWindow.closed) {
                ...
                callPopupWindow = window.open('http://127.0.0.1/stringee/StringeeWebPhone/popup.html', 'Call',
                    'height=740,width=490');
        ...
        StringeeSoftPhone.on('makeOutgoingCallBtnClick', function(fromNumber, toNumber, callType) {
            console.log('makeOutgoingCallBtnClick: fromNumber=' + fromNumber + ', toNumber=' + toNumber +
                ',callType=' + callType);
        ...
        StringeeSoftPhone.on('setRoutingType', function(routingType) {
